...
image `rwynn/monstache:latest` or a specific 4.X image such as `rwynn/monstache:4.11.3`.

If you are working with Elasticsearch 2 or 5 and using the monstache Docker images you should use the docker 
image `rwynn/monstache:rel3` or a specific 3.X image such as `rwynn/monstache:3.18.3`.
...
```
docker run rwynn/monstache:4.11.3 -v

docker run rwynn/monstache:3.18.3 -v
```
