...
```
docker run rwynn/monstache:4.6.0 -v

docker run rwynn/monstache:3.13.0 -v
```
...
```
docker run rwynn/monstache:4.6.0.cgo -v

docker run rwynn/monstache:3.13.0.cgo -v
```
...
docker run --rm --net=host -v ~/plugin:/tmp/plugin rwynn/monstache:4.6.0.cgo -mapper-plugin-path /tmp/plugin/plugin.so
